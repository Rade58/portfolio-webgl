...
const sketch = ({ context }) => {
    ...
    const trianglesMesh = new global.THREE.Mesh(trianglesGeometry, trianglesMaterial);
    ...
    const trianglesMesh2 = new global.THREE.Mesh(trianglesGeometry2, trianglesMaterial2);
