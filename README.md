...
**`sketch1` JE TAJ KOJI JE FOLDER IZ KOJEG SE BUILD-UJE** (NAZVAO SAM GA SA `1` JER CU MOZDA IMATI JOS SKETCH-EVA CISTO RADI PROBAVANJA RAZNIH STVARI, U DRUGIM SKETCH-EVIMA)
