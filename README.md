...
KORISTI CSS VARIJABLE U SVG-JU

MOZDA I DA STORE-UJES I IME CSS VARIJABLE

**KORISTIM PAKET `react-svg`**

**MISLIM DA NE TREBAM OVO DA RADIM, VEC DA KONFIGURIRAM `next-react-svg` PAKET**

# DOZVOLIO SAM SANITY CORS ORIGIN SA localhost:3000 UPRAVO ZBOG ICONA
